...
# Function to initialize the database and create the expenses table if it doesn't exist
def init():
    # Connect to the database
    connectionObjn = db.connect("expenseTracker.db")
    # Create a cursor object to execute SQL commands
    curr = connectionObjn.cursor()
    # SQL query to create the expenses table if it doesn't exist
    query = '''
...
# Function to submit a new expense to the database and display it in the table
def submitexpense():
    ...
    connectionObjn = db.connect("expenseTracker.db")
    curr = connectionObjn.cursor()
    # SQL query to insert the values into the expenses table
    query = '''
...
# Function to view all the expenses in the database
def viewexpense():
    # Connect to the database
    connectionObjn = db.connect("expenseTracker.db")
    # Create a cursor object to execute SQL commands
    curr = connectionObjn.cursor()
    # SQL query to select all the expenses from the expenses table
    query = '''
     select * from expenses
    '''
    # SQL query to select the total amount of expenses from the expenses table
    total='''
